...
export const Stripingandsignage = () => {
  return (
    <div>
      ...
      promptly.
      <br></br>
      We will execute your design layout, inspect and install all necessary line
      striping to ensure your compliance with the Americans with Disabilities
      Act (ADA).
      <br></br>
      ...
      painted parking lot can lend an attractive impression to the overall image
      of your property.
      <br></br>
      <h3>QUALITY</h3>
      At Missouri Asphalt Sealing & Striping, we expertly apply line striping so
      that it results in consistent, sharp lines with well defined edges, starts
      and stops.
      <br></br>
      <h3>SIGNAGE</h3>
